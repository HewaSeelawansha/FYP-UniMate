            ...
            >
                <div className="flex flex-col h-full">
                    <div className='flex gap-4 items-center mb-6'>
                        ...
                        >
                            <IoArrowBackCircleSharp className="text-3xl text-gray-600 hover:text-green" />
                        </button>
                    ...
                    {currentChat ? (
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-white p-6">
                            <div className="max-w-md text-center">
                                <div className="w-24 h-24 bg-gradient-to-r from-orange-300 to-orange-300 rounded-full flex items-center justify-center mx-auto mb-6">
