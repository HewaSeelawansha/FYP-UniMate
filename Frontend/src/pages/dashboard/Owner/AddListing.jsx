...
const AddListing = () => {
  ...
  const listingtitle =
    ltype && boarding?.gender ? `${ltype} for ${boarding?.gender}` : "";
      ...
      <div className="max-w-2xl mx-auto p-6 bg-white rounded-xl shadow-md mt-10">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-2">
            ...
            <span className="text-green-600">{boarding?.status}</span>
          </h2>
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-6">
        <div className="max-w-md text-center bg-white p-8 rounded-xl shadow-lg">
          ...
          <p className="text-gray-600 mb-6">
            You need to register your boarding house before adding listings.
          </p>
          <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                >
                  ...
                  <option value="2-Person Shared Room">
                    2-Person Shared Room
                  </option>
                  <option value="2 to 4-Person Shared Room">
                    2 to 4-Person Shared Room
                  </option>
                  <option value="1-Person Boarding Room">
                    1-Person Boarding Room
                  </option>
                  <option value="Whole House-Short Term">
                    Whole House-Short Term
                  </option>
                  <option value="Whole House-Long Term">
            ...
            <div>
              ...
              {keyMoneyRequired && (
                <div className="mt-4">
                  ...
                  <input
                    {...register("kmoney", {
                      required: keyMoneyRequired
                        ? "Key money amount is required"
                        : false,
                    ...
                    className={`w-full px-4 py-3 border ${
                      errors.kmoney ? "border-red-500" : "border-gray-300"
                    } rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500`}
                  />
                  {errors.kmoney && (
                    <p className="mt-1 text-sm text-red-600">
                      {errors.kmoney.message}
                    </p>
                  )}
                </div>
              )}
