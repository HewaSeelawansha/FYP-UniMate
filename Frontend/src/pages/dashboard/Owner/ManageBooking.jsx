          ...
          <div className="flex items-center">
            ...
            <div>
              <p className="font-semibold text-emerald-800">
                Pending Approvals: {bookings.filter(b => b.status === 'Pending').length} bookings need your attention
              </p>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-3 sm:space-y-0">
                  <div className="flex space-x-3">
                    <Link 
                      ...
                      className="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 transition duration-200"
                    >
                    ...
                    <button 
                      ...
                      className="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-orange-50 text-orange-600 hover:bg-orange-100 transition duration-200"
                    >
                  ...
                  <div className="flex items-center space-x-2 w-full sm:w-auto">
                    <select
                      className="text-sm rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500 bg-gray-50 px-3 py-2"
                    ...
                    <button 
                      ...
                      className="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-green-600 text-white hover:bg-green-700 transition duration-200"
                    >
